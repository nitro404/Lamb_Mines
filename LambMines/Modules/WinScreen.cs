...
namespace LambMines
{
	 ...
	 */
	public class WinScreenModule : XNAModule
	{
		 ...
		 */
		public WinScreenModule()
			: base(MODULE_IDENTIFIER.MID_WIN_MODULE)
		{
		...
		public override void Initialize()
		{
			...
			splashTexture = ParentApp.Content.Load<Texture2D>("Content/Textures/screens_success01");
		...
		public override MODULE_IDENTIFIER Update(double fTotalTime, float fElapsedTime)
		{
			...
			if (ParentApp.Inputs.IsKeyDown(Keys.Enter) || ParentApp.Inputs.IsButtonPressed(0, Buttons.A))
				return MODULE_IDENTIFIER.MID_LOSE_MODULE;
