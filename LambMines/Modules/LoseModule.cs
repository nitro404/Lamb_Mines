...
namespace LambMines
{
	 ...
	 */
	public class LooseScreenModule : XNAModule
	{
		 ...
		 */
		public LooseScreenModule()
			: base(MODULE_IDENTIFIER.MID_LOSE_MODULE)
		{
		...
		public override void Initialize()
		{
			...
			splashTexture = ParentApp.Content.Load<Texture2D>("Content/Textures/screens_fail01");
